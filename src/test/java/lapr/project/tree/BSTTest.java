...
class BSTTest {
    ...
    public void testRemove() {
        ...
        instance.remove(999);
        assertEquals(instance.size(), 0, "size should be = 0");
    }
    ...
    void biggestElement() {
        int expected=50;
        int biggest=instance.biggestElement();
